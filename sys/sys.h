...
static inline void sys_set_map(
  u32 mapstart, // matching sys_set_bg_config
  u32 offset,
  u16 value
) {
  *(u16 *)(((void *)0x06000000) + mapstart * 0x800 + offset) = value;
}
...
static inline void sys_set_bgt0_scroll(i32 x, i32 y) {
  REG_BG0HOFS = x;
  REG_BG0VOFS = y;
}

static inline void sys_set_bgt1_scroll(i32 x, i32 y) {
  REG_BG1HOFS = x;
  REG_BG1VOFS = y;
}

static inline void sys_set_bgt2_scroll(i32 x, i32 y) {
  REG_BG2HOFS = x;
  REG_BG2VOFS = y;
}

static inline void sys_set_bgt3_scroll(i32 x, i32 y) {
  REG_BG3HOFS = x;
  REG_BG3VOFS = y;
}
